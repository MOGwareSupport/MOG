...
namespace MOG_ControlsLibrary
{
	...
	/// </summary>
	public class MogControl_LocalRepositoryTreeView_ClientLoader : System.Windows.Forms.UserControl
	{
		...
		public MogControl_LocalRepositoryTreeView_ClientLoader()
		{
		...
		private void PopulateLocalDrives()
		{
			...
			foreach (string drive in Directory.GetLogicalDrives())
			{
				...
				{
					MessageBox.Show(e.Message, "Cannot show drive!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				}
			}
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(MogControl_LocalRepositoryTreeView_ClientLoader));
			...
			// 
			// MogControl_LocalRepositoryTreeView_ClientLoader
			// 
			this.Controls.Add(this.GameDataTreeView);
			this.Name = "MogControl_LocalRepositoryTreeView_ClientLoader";
