...
namespace BrightIdeasSoftware
{
    ...
    public partial class ObjectListView : ListView, ISupportInitialize
	{
			...
			: base()
		{
            ...
            this.Layout += new LayoutEventHandler(HandleLayout);
            this.ColumnWidthChanging += new ColumnWidthChangingEventHandler(HandleColumnWidthChanging);
            this.ColumnWidthChanged += new ColumnWidthChangedEventHandler(HandleColumnWidthChanged);
        ...
        protected void ResizeFreeSpaceFillingColumns()
        {
            ...
            int freeSpace = this.ClientSize.Width - 1;
