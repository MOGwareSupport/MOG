...
namespace MOG_ControlsLibrary.Common.MogControl_GameDataDestinationTreeView
{
	/// <summary>
	...
	public class MogControl_GameDataDestinationTreeView : System.Windows.Forms.UserControl
	{
		...
		private System.Windows.Forms.ContextMenu GameDataContextMenu;
		private System.Windows.Forms.MenuItem GameDataCreateMenuItem;
		public System.Windows.Forms.MenuItem GameDataRenameMenuItem;
		public System.Windows.Forms.MenuItem GameDataDeleteMenuItem;
		...
		public TreeNode MOGSelectedNode
		{
			...
			{ 
				if (GameDataTreeView != null)
				{
					return GameDataTreeView.SelectedNode;
				}
			...
			set 
			{
				GameDataTreeView.SelectedNode = value;
			}
		}
		...
		private void VirtualFindAndExpand(string fullNodeName, string fullName)
		{
			...
			if (parts != null && parts.Length > 0)
			{
				...
				foreach (string name in parts)
				{
					...
					if (node != null)
					{
						// If we find it, expand that treenode
						node.Expand();
		...
		{
			TreeNode selected = FindNodeDeep(mRoot, path);
		...
		private void InitializeComponent()
		{
			...
			this.GameDataContextMenu = new System.Windows.Forms.ContextMenu();
			this.GameDataCreateMenuItem = new System.Windows.Forms.MenuItem();
			this.GameDataRenameMenuItem = new System.Windows.Forms.MenuItem();
			this.GameDataDeleteMenuItem = new System.Windows.Forms.MenuItem();
			...
			this.GameDataTreeView.ContextMenu = this.GameDataContextMenu;
			...
			// GameDataContextMenu
			// 
			this.GameDataContextMenu.MenuItems.AddRange(new System.Windows.Forms.MenuItem[] {
            this.GameDataCreateMenuItem,
            this.GameDataRenameMenuItem,
            this.GameDataDeleteMenuItem});
			this.GameDataContextMenu.Popup += new System.EventHandler(this.GameDataContextMenu_Popup);
			// 
			// GameDataCreateMenuItem
			// 
			this.GameDataCreateMenuItem.Enabled = false;
			this.GameDataCreateMenuItem.Index = 0;
			...
			this.GameDataRenameMenuItem.Index = 1;
			...
			this.GameDataDeleteMenuItem.Index = 2;
				...
				try
				{
					...
					if (mVirtual)
					{
						...
						if (info != null)
						{
							...
							if (info.Object != null)
							{
								targetGamdeData = (MOG_ControllerSyncData)info.Object;
							}
							...
							VirtualExpand(e.Node, info.FullFilename, targetGamdeData);

							// Add any non MOG files
							FillDirectory(e.Node, info.FullFilename, SystemColors.InactiveCaptionText);
						}
					}
		...
		private void GameDataContextMenu_Popup(object sender, System.EventArgs e)
		{
			...
			if (GameDataTreeView.SelectedNode != null && GameDataTreeView.SelectedNode.Tag != null)
			{
				...
				// We can only rename and delete directories that both exist and are non mog controlled (SystemColors.InactiveCaptionText)
				if (Directory.Exists(tag.FullFilename) && GameDataTreeView.SelectedNode.ForeColor == SystemColors.InactiveCaptionText)
				{
