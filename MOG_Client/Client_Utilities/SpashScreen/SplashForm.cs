...
namespace AppLoading
{
	...
	public class SplashForm : System.Windows.Forms.Form
	{
		...
		private void InitializeMainMogForm(string[] args)
		{
			...
			Refresh();
			intializeProgressBar(11);
			Refresh();

			updateSplash("Initializing main", 0);
			mainForm = new MogMainForm(args);
		...
		public void updateSplash(string str, int sleepTime)
		{
			...
			//SplashProgressBar.Text = str;
			SplashProgressBar.Position += 1;//.PerformStep();
			Splash.Refresh();
			Update();
		...
		private void InitializeComponent()
		{
			...
			this.VersionLabel.Location = new System.Drawing.Point(462, 7);
			this.VersionLabel.Name = "VersionLabel";
			this.VersionLabel.Size = new System.Drawing.Size(133, 11);
			this.VersionLabel.TabIndex = 3;
			this.VersionLabel.Text = "3.0.0.23453";
			...
			this.SplashLabel.Text = "Initializing MOG Client...";
			...
			this.pictureBox1.Image = global::MOG_Client.Properties.Resources.Splash_Client_2005;
