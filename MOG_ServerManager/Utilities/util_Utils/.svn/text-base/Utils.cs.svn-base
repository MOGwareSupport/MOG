...
namespace MOG_ServerManager.Utilities
{
	...
	public class Utils
	{
		...
		public static MOGPromptResult ShowMessageBoxExclamation(string text, string title)
		{
			return MOG_Prompt.PromptResponse(title, text, "", MOGPromptButtons.OK, MOG_ALERT_LEVEL.CRITICAL);
		}

		public static MOGPromptResult ShowMessageBoxConfirmation(string text, string title)
		{			
			return MOG_Prompt.PromptResponse(title, text, "", MOGPromptButtons.YesNo, MOG_ALERT_LEVEL.ALERT);
		}
