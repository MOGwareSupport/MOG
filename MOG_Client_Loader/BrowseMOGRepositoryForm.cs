...
{
	/// <summary>
	/// Summary description for BrowseMOGRepositoryForm.
	/// </summary>
	public class BrowseMOGRepositoryForm : System.Windows.Forms.Form
	{
		private MOG_ControlsLibrary.Common.MogControl_LocalRepositoryTreeView.MogControl_LocalRepositoryTreeView mogControl_LocalRepositoryTreeView;
		...
		public BrowseMOGRepositoryForm()
		{
			//
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(BrowseMOGRepositoryForm));
			this.mogControl_LocalRepositoryTreeView = new MOG_ControlsLibrary.Common.MogControl_LocalRepositoryTreeView.MogControl_LocalRepositoryTreeView();
			...
			this.Name = "BrowseMOGRepositoryForm";
