...
namespace MOG_Server.MOG_ControlsLibrary.Admin
{
	...
	public class SqlServerLocator
	{
		...
		public static ArrayList FindDatabases(string serverName)
		{
			...
			{
				MessageBox.Show("Couldn't access server " + serverName, "Error", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
			}
...
//				serverName, UserId, Password, TimeOut);
			...
			string connString = IntegratedSecurity ?
				String.Format("Provider=SQLOLEDB;Data Source={0};Integrated Security=SSPI;Connect Timeout=5", serverName)
				: String.Format("Provider=SQLOLEDB;Data Source={0};User Id={1};Password={2};Connect Timeout=5",
